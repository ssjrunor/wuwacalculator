...
const data = {
    ...
    coverage: [
        ...
        },
        {
            ...
            desc: 'All characters supported. So far only 3.0 characters have Tune Rupture data.',
        },
        {
            title: 'Weapon Coverage',
            desc: 'All but 6 weapons supported as they\'re yet to get en data.',
        },
        {
            title: 'Echoes Coverage',
            desc: 'All echoes and sonata sets supported. All newly added sets and echoes are missing icon images.',
        },
        {
