...
export default function TaoqiUI() {
    ...
    return (
        <div className="inherent-skills">
            ...
            {skills.map((node, index) => {
                ...
                const steadfast = lowerName.includes("steadfast protection");
                const unlockLevel = steadfast ? 70 : 50;
                const locked = charLevel < unlockLevel;

                if (locked) {
                    if (steadfast && activeStates.inherent1) updateState('inherent1', false);
                }
...
export function taoqiSequenceToggles({ nodeKey, sequenceToggles, toggleSequence, currentSequenceLevel }) {
