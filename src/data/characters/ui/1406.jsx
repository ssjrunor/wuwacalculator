...
export default function AeroMUI() {
    ...
    return (
        <div className="inherent-skills">
            ...
            {skills.map((node, index) => {
                ...
                const storm = lowerName.includes("sand in the storm");
                const boundless = lowerName.includes("boundless winds");

                const unlockLevel = unlockLevels[index] ?? 1;
                const locked = charLevel < unlockLevel;

                if (locked) {
                    if (storm && activeStates.inherent1) {
                        toggleState('inherent1');
                    }
                    if (boundless && activeStates.inherent2) {
...
export function aeroMSequenceToggles({
                                         nodeKey,
                                         sequenceToggles,
                                         toggleSequence,
