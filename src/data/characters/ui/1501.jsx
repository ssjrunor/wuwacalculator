...
export default function SpectroMUI() {
    ...
    return (
        <div className="inherent-skills">
            ...
            {skills.map((node, index) => {
                ...
                const listener = lowerName.includes("silent listener");
                const unlockLevel = listener ? 70 : 50;
                const locked = charLevel < unlockLevel;

                if (locked) {
                    if (listener && activeStates.inherent2) updateState('inherent2', false);
                }
...
export function spectroMSequenceToggles({ nodeKey, sequenceToggles, toggleSequence, currentSequenceLevel }) {
