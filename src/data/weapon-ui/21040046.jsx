...
export function WeaponUI({
    ...
    const pleniluneStacks = characterRuntimeStates?.[charId]?.activeStates?.pleniluneStacks ?? 0;
    ...
    return (
        <div className="status-toggles">
            <div className="status-toggle-box">
                ...
                <div className="status-toggle-box-inner">
                    <p>
                        {highlightKeywordsInText(`Casting Intro Skill or Resonance Liberation increases Resonance Liberation DMG by ${currentParamValues[1]} for 15s.`, keywords)}
                    </p>
                    ...
                    <p>
                        {highlightKeywordsInText(`Obtaining Shield allows Resonance Liberation DMG to ignore ${currentParamValues[3]} of the 
