        ...
        <div className="status-toggles">
            <div className="status-toggle-box">
                <div className="status-toggle-box-inner">
                    <p>
                        {highlightKeywordsInText(`Casting Resonance Skill increases the wielder's Resonance Liberation DMG Bonus by ${currentParamValues[0]}, lasting for 15s.`, keywords)}
                    </p>
                </div>
